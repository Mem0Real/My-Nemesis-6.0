...
export default function Cart({ closeCartModal, cartModal, cartModalRef }) {
	...
	return (
		<motion.section
			ref={cartModalRef}
			className="max-h-screen overflow-y-auto min-h-fit my-auto w-[90%] sm:w-[75%] md:w-[60%] lg:w-[50%] ml-auto rounded-lg bg-neutral-200 dark:bg-neutral-800 text-neutral-800 dark:text-neutral-200"
