...
export const Navbar = async () => {
  ...
  return (
    ...
    text-neutral-800 dark:bg-neutral-900 dark:text-neutral-200 border-b border-neutral-400/60 backdrop-blur-md shadow-md shadow-neutral-300 dark:shadow-neutral-700 relative z-10"
    >
