...
export default function CustomCursor({ children }) {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className={`invisible md:visible ${styles.cursor} shadow-inner shadow-red-800 border border-neutral-800 dark:border-neutral-200 opacity-60 w-20 h-20 backdrop-blur-sm z-50`}
        animate={{
          translateX: -32,
          translateY: -32,
          rotateX,
