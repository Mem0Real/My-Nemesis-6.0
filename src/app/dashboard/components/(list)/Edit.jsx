...
export default function EditModal({
	...
	return (
		<motion.section
			ref={editRef}
			className="h-[95%] w-[85%] md:w-[40%] lg:w-[30%] my-5 overflow-y-scroll no-scrollbar md:py-3 ml-auto rounded-lg bg-neutral-300 dark:bg-neutral-900 text-neutral-800 dark:text-neutral-200"
