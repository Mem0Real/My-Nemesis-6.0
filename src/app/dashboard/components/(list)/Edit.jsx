...
export default function EditModal({
  ...
  return (
    <section
      className="h-[95%] w-[85%] md:w-[40%] lg:w-[30%] my-5 no-scrollbar md:py-3 mx-auto overflow-y-scroll rounded-lg bg-neutral-900"
      ref={modalRef}
    >
      <header className="pb-4 relative">
        ...
        <h3 className="border-b border-neutral-200 mb-4 py-4 text-xl text-neutral-200 text-center font-medium">
