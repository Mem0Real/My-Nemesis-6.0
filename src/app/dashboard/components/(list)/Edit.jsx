...
export default function Edit({
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(() => true);
    const loaderToast = toast.loading("Updating Data");
  ...
  return (
    <Modal
      ...
      className="absolute top-12 md:top-24 w-[85%] h-[90%] md:w-2/5 my-6 md:mt-0 md:py-3 mx-auto overflow-y-auto no-scrollbar rounded-lg"
    >
      <Box className="">
