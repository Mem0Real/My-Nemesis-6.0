...
export default function TopMask() {
	...
	return (
		...
		>
			<motion.div
				className={`window absolute left-0 top-0 grid gap-2 p-3 pt-6 [grid-template-rows:4fr_1fr] origin-[50%_62%] md:origin-[94%_32%] lg:origin-[${maskPositionX}_${maskPositionY}] `}
				style={{ scale }}
			>
				<div
					ref={scaleRef}
