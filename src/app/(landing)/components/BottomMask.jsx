			...
			<div ref={rootRef} className="relative z-10 h-[150vh] overflow-clip">
				...
				>
					...
					>
						<div
							ref={maskRef}
							className="mx-auto my-12 box-content aspect-[3/8] md:aspect-[5/8] min-w-[100px] rounded-full border-[2px] border-gray-800 dark:border-gray-300 md:my-auto md:-ml-1 md:mr-auto md:min-w-[150px] overflow-hidden"
						>
					...
					>
						...
						>
							<div className="relative w-full h-full flex flex-col justify-center items-center z-10 bg-neutral-100 dark:bg-neutral-900">
								<motion.h1
