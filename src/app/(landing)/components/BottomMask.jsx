...
export default function BottomMask() {
	...
	moveTextX = useTransform(scrollYProgress, [0, 1], [200, -150]);
	...
	return (
		...
		>
			...
			>
				<div
					ref={scaleRef}
					className={`relative flex flex-col md:flex-row justify-start rounded-3xl bg-neutral-100 dark:bg-neutral-900 text-neutral-800 dark:text-neutral-200 px-5`}
				>
					<div className="flex min-h-72 md:h-full flex-col py-2 mt-2 md:pb-12 md:mt-6 gap-2 md:gap-6">
