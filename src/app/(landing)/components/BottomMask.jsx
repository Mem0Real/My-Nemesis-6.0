			...
			<div ref={rootRef} className="relative z-10 h-[150vh] overflow-clip">
				...
				>
					...
					>
						<div
							ref={maskRef}
							className="relative mx-auto my-12 box-content aspect-[5/8] w-[100px] min-w-[100px] rounded-full border-[2px] border-gray-800 dark:border-gray-300 md:my-auto md:-ml-1 md:mr-auto md:w-[150px] md:min-w-[150px] overflow-hidden"
						>
