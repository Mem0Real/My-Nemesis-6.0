	...
	return (
		<main className=" bg-neutral-100 dark:bg-neutral-800 backdrop-blur-lg">
			<div ref={ref} className="relative z-10 h-[180vh] overflow-clip">
				<motion.div
					style={{ scale }}
					className={`${styles.heroBackground} absolute right-0 bottom-0 grid w-screen h-screen gap-2 p-6 pt-20 [grid-template-rows:4fr_1fr] origin-[50%_30%] md:origin-[16%_48%] lg:origin-[8%_48%]`}
				>
					<div
					...
					>
						...
						<div className="flex h-full flex-col py-12 -mt-12 gap-12">
							<h1 className="mb-5 max-w-[12ch] text-4xl font-bold leading-[0.85] md:my-auto md:text-6xl xl:text-7xl text-right">
								For all your purchase needs!
							</h1>
							<p className="text-lg md:text-3xl text-right">
