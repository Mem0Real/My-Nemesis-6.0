    ...
    <AnimatePresence>
      {openCategory && (
        <motion.aside
          ...
          className="bg-neutral-100/70 dark:bg-neutral-900/70 backdrop-blur-lg border-b border-purple-700 dark:border-purple-500 rounded-lg rounded-l-none min-h-72 h-fit"
        >
          <motion.div
