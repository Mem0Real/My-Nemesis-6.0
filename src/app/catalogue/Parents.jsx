...
export default async function Parents({ categoryId, parents }) {
	return (
		<Slider parents={parents} categoryId={categoryId} />
		// {parents.map((parent) => {
		// 	return (
		...
		// 				</div>
		// 				</div>
		// 				<div className="border border-neutral-400 rounded-b-2xl text-center text-sm py-5 hover:underline underline-offset-2 w-full">
		// 					<Link
		// 						key={parent.id}
